...
public class CacheConfiguration {
    ...
    public CacheManager cacheManager() {
        ...
        Cache userCache = cacheManager.getCache("com.exteso.lab.pf.domain.User");
        ...
        Cache authoritiesCache = cacheManager.getCache("com.exteso.lab.pf.domain.Authority");
        ...
        Cache persistentTokenCache = cacheManager.getCache("com.exteso.lab.pf.domain.PersistentToken");
