package com.exteso.lab.pf.config.reload.instrument;
    ...
    public byte[] modify(String slashedClassName, ClassLoader classLoader, byte[] bytes) {
        ...
        try {
            ...
            if (StringUtils.equals(slashedClassName, "liquibase/ext/hibernate/snapshot/TableSnapshotGenerator")) {
                ...
                ctClass.setSuperclass(classPool.get("com.exteso.lab.pf.config.reload.patch.liquibase.JHipsterTableSnapshotGenerator"));
            ...
            if (StringUtils.equals(slashedClassName, "org/hibernate/jpa/HibernatePersistenceProvider")) {
                ...
                ctClass.setSuperclass(classPool.get("com.exteso.lab.pf.config.reload.instrument.hibernate.JHipsterPersistenceProvider"));
